...
function ActiveSessions({ sessions, isLoading, isUserInSession }) {
  return (
    <div className="lg:col-span-2 card bg-base-200 border-2 border-primary/20 hover:border-primary/30 h-full">
        ...
        <div className="space-y-3 max-h-100 overflow-y-auto pr-2">
          {isLoading ? (
              ...
              >
                <div className="flex items-center justify-between gap-4 p-5">
                  ...
                  <div className="flex items-center gap-4 flex-1">
                    <div className="relative size-14 rounded-xl bg-linear-to-br from-primary to-secondary
            ...
            <div className="text-center py-16">
              <div className="w-20 h-20 mx-auto mb-4 bg-linear-to-br from-primary/20 to-secondary/20
