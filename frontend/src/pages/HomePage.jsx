...
import { ArrowRightIcon, CheckIcon, CheckLine, Code2Icon, SparklesIcon, UsersIcon, VideoIcon, ZapIcon } from "lucide-react";
    ...
    <div className="bg-linear-to-br from-base-100 via-base-200 to-base-300" >
      ...
      z-50 shadow-lg">
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
          ...
          >
            <div className="size-10 rounded-xl bg-linear-to-br from-primary via-secondary to-accent 
            flex items-center justify-center shadow-lg">
              <SparklesIcon className="size-6 text-white" />
            </div>

            <div className="flex flex-col">
              <span className="font-black text-xl bg-linear-to-r from-primary via-secondary
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-7 -mt-9">
            ...
            <h1 className="text-5xl lg:text-7xl font-black leading-tight">
              <span className="bg-linear-to-r from-primary via-secondary to-accent
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-base-content/70 max-w-2xl mx-auto">
            Powerfull features designed to make your coding interviews seamless and productive
          </p>
        </div>
